...
echo "Starting seed_42 model evaluation with 10000 test samples..."
...
# Run evaluation for seed_42 with 10000 test samples
...
echo "Time: $(date)"
echo "Results saved to: multi_seed_evaluation_10000_seed42_results/"
