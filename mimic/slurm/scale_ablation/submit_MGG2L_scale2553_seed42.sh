#!/bin/bash
#SBATCH --job-name=sc2553_MGG2L_s42
#SBATCH --output=logs/scale2553_MGG2L_seed42_%j.out
#SBATCH --error=logs/scale2553_MGG2L_seed42_%j.err
...
python3 -u train_retrieval_v2_paper2.py \
    --experiment_name mimic_shards_hybrid_full_ori_vo10805_to128_lr1e-4_b128_ep400_dualbr_sy065_main_loss20_ortho15__branch_MGG2L_paper2_scale2553_seed_42 \
