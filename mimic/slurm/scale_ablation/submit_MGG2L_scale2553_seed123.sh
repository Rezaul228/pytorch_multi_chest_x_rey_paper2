#!/bin/bash
#SBATCH --job-name=sc2553_MGG2L_s123
#SBATCH --output=logs/scale2553_MGG2L_seed123_%j.out
#SBATCH --error=logs/scale2553_MGG2L_seed123_%j.err
...
#SBATCH --qos=normal
# MIMIC data-scale ablation (pre-registered 2026-09-19): 2553 training studies,
# MGG2L arm, seed 123. Small-data recipe proven on Open-I: batch 128, lr 1e-4,
...
# later epoch, NO early stopping. 400 epochs. The id lists are fixed and shared by
...
python3 -u train_retrieval_v2_paper2.py \
    --experiment_name mimic_shards_hybrid_full_ori_vo10805_to128_lr1e-4_b128_ep400_dualbr_sy065_main_loss20_ortho15__branch_MGG2L_paper2_scale2553_seed_123 \
