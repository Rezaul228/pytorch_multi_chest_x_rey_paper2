#!/bin/bash
#SBATCH --job-name=a2_10000_v1_s17
#SBATCH --output=logs/a2_scale10000_v1_seed17_%j.out
#SBATCH --error=logs/a2_scale10000_v1_seed17_%j.err
...
python3 -u train_retrieval_v2.py \
    --experiment_name mimic_shards_hybrid_full_ori_vo10805_to128_lr1e-4_b128_ep385_dualbr_sy065_main_loss20_ortho15__branch_v1_scale10000_seed_17 \
