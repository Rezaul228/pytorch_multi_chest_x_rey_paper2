#!/usr/bin/env python3
"""
ENHANCED NOISE SENSITIVITY TESTING
Test with realistic enhanced intensities for brightness and blur
"""
...
def load_model_and_data():
    ...
    test_dataset = data_loader.get_test_data(num_samples=200)
...
def save_results_to_file(results, baseline_results, timestamp):
    ...
    with open(filename, 'w') as f:
        f.write("ENHANCED NOISE SENSITIVITY TESTING RESULTS\n")
        f.write("=" * 60 + "\n\n")
...
def test_enhanced_noise_sensitivity():
    ...
    print("🔬 ENHANCED NOISE SENSITIVITY TESTING")
    print("=" * 70)
    print("📋 Approach: Test with realistic enhanced intensities for brightness and blur")
    print("=" * 70)
    ...
    # Define ENHANCED noise tests with realistic intensities
    noise_tests = [
        # Image noise tests - keep original intensities for Gaussian and Salt-Pepper
        ('gaussian', 0.05, 'Low Gaussian Noise'),
        ('gaussian', 0.1, 'Medium Gaussian Noise'),
        ('gaussian', 0.2, 'High Gaussian Noise'),
        ('salt_pepper', 0.05, 'Low Salt-Pepper Noise'),
        ('salt_pepper', 0.1, 'Medium Salt-Pepper Noise'),
        ('salt_pepper', 0.2, 'High Salt-Pepper Noise'),
        
        # ENHANCED brightness tests with realistic intensities
        ('brightness', 0.7, 'Medium Brightness Variation'),
        ('brightness', 0.9, 'High Brightness Variation'),
        ('brightness', 1.3, 'Very High Brightness Variation'),
        
        # ENHANCED blur tests with realistic intensities
        ('blur', 0.4, 'Medium Motion Blur'),
        ('blur', 0.6, 'High Motion Blur'),
        ('blur', 0.9, 'Very High Motion Blur'),
        
        # Text noise tests - keep original
        ('typos', 0.05, 'Low Typo Rate'),
        ('typos', 0.1, 'Medium Typo Rate'),
        ('typos', 0.2, 'High Typo Rate'),
    ]
