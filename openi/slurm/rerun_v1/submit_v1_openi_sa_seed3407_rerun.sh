#!/bin/bash
#SBATCH --job-name=openisa_v1_s3407_rerun
#SBATCH --output=logs/openisa_v1_s3407_rerun_%j.out
#SBATCH --error=logs/openisa_v1_s3407_rerun_%j.err
...
python3 -u train_retrieval_v2.py \
    --experiment_name openi_sa_vo10805_to128_lr1e-4_b128_ep100_dualbr_sy065_main_loss20_ortho15__branch_v1_seed_3407_rerun \
